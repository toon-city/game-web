    ...
    this.subs.push(
      this.socket.userJoined$.subscribe((p) => {
        this.users.update((list) => [
          ...
          { userId: p.userId, username: p.username, skinColor: p.skinColor, hairColor: p.hairColor, clothing: p.clothing, direction: p.direction, x: p.x, y: p.y, gender: p.gender, rank: p.rank, toonizLevel: p.toonizLevel },
        ]);
      }),
